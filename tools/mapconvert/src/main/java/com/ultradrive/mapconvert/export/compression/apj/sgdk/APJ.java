package com.ultradrive.mapconvert.export.compression.apj.sgdk;
...
public class APJ
{
     ...
     */
    public static byte[] pack(byte[] data, boolean ultra) throws IOException, IllegalArgumentException
    {
        // data length
